          ...
          <table className="table align-middle p-4 mb-0 table-hover table-shrink">
            ...
            <tbody className="border-top-0">
              ...
              return <tr key={idx}>
                    ...
                    <td>
                      {' '}
                      <div className={clsx('badge bg-opacity-10', invoice.status == 'Cancelled' ? 'bg-danger text-danger' : invoice.status == 'Pending' ? 'text-warning bg-warning' : 'text-success bg-success')}>
                        {invoice.status}
                      </div>{' '}
                    </td>
                    <td>
