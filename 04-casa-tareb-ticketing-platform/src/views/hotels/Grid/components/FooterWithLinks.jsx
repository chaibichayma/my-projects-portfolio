      ...
      <Container>
        <Row className="g-4">
          <Col lg={3}>
            ...
            <p className="my-3 text-body-secondary">Des événements uniques et mémorables, alliant organisation soignée et ambiance exceptionnelle pour tous les participants.</p>
            <p className="mb-2">
        ...
        <Row className="mt-5">
          <h5 className="mb-2 text-white">Principaux liens</h5>
        ...
        <Row className="g-4 justify-content-between mt-0 mt-md-2">
          <Col sm={7} md={6} lg={4}>
            <h5 className="text-white mb-2">Paiement &amp; sécurité</h5>
          ...
          <Col sm={5} md={6} lg={3} className="text-sm-end">
            <h5 className="text-white mb-2">Suivez-nous sur</h5>
          ...
          <Container>
            <div className="d-lg-flex justify-content-between align-items-center py-3 text-center text-lg-start">
              <div className="text-body-secondary text-primary-hover">
                {' '}
                Droits d’auteur ©{currentYear} . Conçu par{' '}
