      ...
      <div>
        ...
        <ul className={clsx('navbar-nav navbar-nav-scroll me-auto ', menuClassName)}>
          ...
          return <Fragment key={item.key + idx}>
                {item.children ? <MenuItemWithChildren item={item} activeMenuItems={activeMenuItems} level={1} itemClassName="nav-item" linkClassName={clsx('nav-link arrow-none d-flex align-items-center gap-1 justify-content-between text-body-secondary', {
