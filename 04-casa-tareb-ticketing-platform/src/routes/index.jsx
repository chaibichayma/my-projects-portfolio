...
const MyOfferList = lazy(() => import('@/views/listing-pages/MyOfferList'));
const SignIn = lazy(() => import('@/views/auth/SignIn'));
const SignUp = lazy(() => import('@/views/auth/SignUp'));
const ForgotPassword = lazy(() => import('@/views/auth/ForgotPassword'));
const ForgotPasswordCode = lazy(() => import('@/views/auth/ForgotPasswordCode'));
...
const CommandePage = lazy(() => import('@/views/hotels/HotelDetails/components/Commande'));
const AppelerPayment = lazy(() => import('@/views/hotels/HotelDetails/components/Appeler'));
const ConfirmerTicket = lazy(() => import('@/views/listing-pages/BookingConfirm/components/ConfirmTicket'));
...
}, 
{
  ...
  element: <HotelBooking />
    ...
    path: '/hotels/commande',  // ← chemin pour la page commande
    name: 'hotels.commande',
    element: <CommandePage />   // ← ton composant commande
  },
  {
    path: '/evenement/payment',
    name: 'hotels.payment',
    element: <AppelerPayment />
  }];
const flightsRoutes = [{
  path: '/flights/home',
  name: 'flights.home',
...
export const authRoutes = [{
  ...
  name: 'auth.forgot-password-code',
