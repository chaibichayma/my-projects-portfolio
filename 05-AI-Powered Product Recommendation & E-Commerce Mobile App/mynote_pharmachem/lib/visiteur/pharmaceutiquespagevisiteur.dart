...
class PharmaceutiquesPageVisiteur extends StatefulWidget {
  final String userId;
  final DocumentSnapshot productData;
  final Product product;

  PharmaceutiquesPageVisiteur({required this.userId, required this.productData, required this.product});

  @override
  _PharmaceutiquesPageVisiteurState createState() => _PharmaceutiquesPageVisiteurState();
}

class _PharmaceutiquesPageVisiteurState extends State<PharmaceutiquesPageVisiteur> {
