...
import 'package:mynote_pharmachem/visiteur/biologiquepagevisitaur.dart';
import 'package:mynote_pharmachem/visiteur/cosmetiquespagevisiteur.dart';
import 'package:mynote_pharmachem/visiteur/pharmaceutiquespagevisiteur.dart';
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Category(
              ...
              onTap: () {
                ...
                context,
                MaterialPageRoute(
                  builder: (context) => CosmetiquesPageVisiteur(
                    product: product,
                    userId: userId,
          ...
          Padding(
            ...
            child: Category(
              ...
              image_caption: 'Biological',
              onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => BiologiquesPageVisiteur(
                    product: product,
                    userId: userId,
                    productData: productData,
                  ),
          ...
          Padding(
            ...
            child: Category(
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => PharmaceutiquesPageVisiteur(
                    product: product,
                    userId: userId,
                    productData: productData,
                  ),
