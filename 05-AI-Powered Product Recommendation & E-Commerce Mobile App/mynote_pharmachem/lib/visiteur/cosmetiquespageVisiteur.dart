...
class CosmetiquesPageVisiteur extends StatefulWidget {
  final String userId;
  final DocumentSnapshot productData;
  final Product product;

  CosmetiquesPageVisiteur({required this.userId, required this.productData, required this.product});

  @override
  _CosmetiquesPageVisiteurState createState() => _CosmetiquesPageVisiteurState();
}

class _CosmetiquesPageVisiteurState extends State<CosmetiquesPageVisiteur> {
