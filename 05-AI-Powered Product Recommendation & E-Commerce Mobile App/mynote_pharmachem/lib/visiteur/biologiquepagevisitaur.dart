...
import 'package:mynote_pharmachem/visiteur/productCartCatvisiteur.dart';
class BiologiquesPageVisiteur extends StatefulWidget {
  final String userId;
  final DocumentSnapshot productData;
  final Product product;

  BiologiquesPageVisiteur({required this.userId, required this.productData, required this.product});

  @override
  _BiologiquesPageVisiteurState createState() => _BiologiquesPageVisiteurState();
}

class _BiologiquesPageVisiteurState extends State<BiologiquesPageVisiteur> {
  ...
  void paginateProducts() async {
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance
        .collection('products')
        .where('categoryIds', arrayContains: 'biologiquesId')
        .get();
