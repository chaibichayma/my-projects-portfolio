...
import 'dart:async';
class BiologiquesPage extends StatefulWidget {
  final String userId;
  final DocumentSnapshot productData;
  final Product product;

  BiologiquesPage({required this.userId, required this.productData, required this.product});

  @override
  _BiologiquesPageState createState() => _BiologiquesPageState();
}

class _BiologiquesPageState extends State<BiologiquesPage> {
