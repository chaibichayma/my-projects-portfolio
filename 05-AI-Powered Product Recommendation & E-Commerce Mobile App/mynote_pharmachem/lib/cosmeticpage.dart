...
import 'dart:async';
class CosmetiquesPage extends StatefulWidget {
  final String userId;
  final DocumentSnapshot productData;
  final Product product;

  CosmetiquesPage({required this.userId, required this.productData, required this.product});

  @override
  _CosmetiquesPageState createState() => _CosmetiquesPageState();
}

class _CosmetiquesPageState extends State<CosmetiquesPage> {
