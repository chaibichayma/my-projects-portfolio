...
import 'dart:async';
class ProductCardCat extends StatefulWidget {
  ...
  @override
  _ProductCardCatState createState() => _ProductCardCatState();
}

class _ProductCardCatState extends State<ProductCardCat> {
  late Timer timer;
...
Widget build(BuildContext context) {
  ...
  return Card(
    ...
    child: GestureDetector(
      onTap: () {
        navigateToProductDetails(widget.product); // Ajouter la navigation vers la page de détails du produit
      },
      child: Column(
